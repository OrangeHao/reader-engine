...
import org.geometerplus.android.fbreader.ambilwarna.AmbilWarnaDialog;
...
public abstract class ColorPreference extends Preference {
	...
	protected void onBindView(View view) {
		...
		if (color!=null){
			view.findViewById(R.id.color_preference_widget).setBackgroundColor(ZLAndroidColorUtil.rgb(color));
		}else {
			view.findViewById(R.id.color_preference_widget).setBackgroundColor(0);
		}
	}
