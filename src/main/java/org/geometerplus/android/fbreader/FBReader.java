...
import org.geometerplus.android.fbreader.api.aidl.ApiListener;
import org.geometerplus.android.fbreader.api.aidl.ApiServerImplementation;
...
public class FBReader extends Activity implements ZLApplicationWindow
{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		main_view=(ZLAndroidWidget)findViewById(R.id.main_view);
        init();
	}
	...
	{
		context.startActivity(new Intent(context, FBReader.class).setAction(ACTION_OPEN_BOOK)
