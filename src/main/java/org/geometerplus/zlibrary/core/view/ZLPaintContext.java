...
abstract public class ZLPaintContext
{
	...
	public final void setFootFont()
	{
		setFontInternal(myFontFamily, myFontSize-2, myFontIsBold, myFontIsItalic, myFontIsUnderlined, myFontIsStrikedThrough);
		mySpaceWidth = -1;
		myStringHeight = -1;
		myDescent = -1;
	}
	...
	{
		OriginalSize, IntegerCoefficient, FitMaximum
	}
